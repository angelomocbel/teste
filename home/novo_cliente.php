...
<html>
    ...
    </script><link href="../resource/css/geral.css" rel="stylesheet" type="text/css"/>
    <title></title>
</head>
<body>
    <div id="geral">
        ...
        <div id="lateral">
            <img width="50" src="../resource/img/add.png" alt=""/>
            <img width="50" src="../resource/img/search.png" alt=""/>
            <img width="40" src="../resource/img/menu.png" alt=""/>
        </div>
        ...
        <footer id="rodape"><?php print 'advoc em desenvolvimento'; ?></footer>
    </div>
</body>
</html>
